...
/// @title Pool 'Fundraiser' contract
/// @author Tendos (@TendosBG)
...
contract Pool is Ownable {
    ...
    /// @notice Withdraw the funds from the pool
    ...
    /// @notice Allows the owner to withdraw the funds from the pool
    ...
    /// @notice Allows the user to get his money back if the goal is not reached
